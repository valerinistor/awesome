...
-- Register Widget
vicious.register(mpdwidget, vicious.widgets.mpd, "<span color='#D2D46B'> ♪</span> ${Title}, ${Artist}", 13)
--vicious.register(mpdwidget, vicious.widgets.mpd, " ♪ ${Title}, ${Artist}", 13)
-- Wifiwidget
wifiwidget = widget({ type = "textbox" })
-- Register Widget
vicious.register(wifiwidget, vicious.widgets.wifi, "<span color='#D2D46B'>~</span> ${link}%", 5, "eth1")
